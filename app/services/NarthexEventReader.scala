...
**                          |/                                          **
\*                                                                      */
// gerald@delving.eu: Sorry, needed find a way out of https://issues.scala-lang.org/browse/SI-4267
...
class NarthexEventReader(src: Source) extends scala.collection.Iterator[XMLEvent] with ProducerConsumerIterator[XMLEvent] {
  ...
  private class Parser(val input: Source) extends MarkupHandler with MarkupParser with ExternalSources with Runnable {
    val preserveWS = NarthexEventReader.this.preserveWS
...
trait ProducerConsumerIterator[T >: Null] extends Iterator[T] {
  ...
  def next() = {
    ...
    //gdj: added: from https://github.com/scala/scala-xml/commit/c1db5fd357396f6b9ee847cbaba066f54fc29dc0#diff-0
